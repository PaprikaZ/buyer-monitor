...
var Seed, fs, path, pickOneVerdict, rewire, sinon, urlToHtmlTable, verdict, visitor;
...
verdict = JSON.parse(fs.readFileSync(path.join(__dirname, './cache/verdict.json')));

pickOneVerdict = function() {
  var idx, max, min;
  min = 0;
