...
Parser = (function() {
  ...
  Parser.prototype.mandatoryParseFields = ['title', 'price', 'fullPrice', 'review', 'instore', 'benefits'];

  Parser.prototype.mandatoryFields = ['title', 'price', 'fullPrice', 'discount', 'review', 'instore', 'benefits'];
