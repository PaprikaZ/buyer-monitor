...
var AmazonCNParser, AmazonJPParser, AmazonUSParser, JingdongParser, MANDATORY_FIELD, Parser, cheerio, review, _MANDATORY_PARSE_FIELD,
...
Parser = (function() {
  ...
  Parser.prototype.mandatoryParseFields = _MANDATORY_PARSE_FIELD;

  Parser.prototype.mandatoryFields = MANDATORY_FIELD;
...
module.exports.newParser = function(site) {
  var newParser;
  newParser = (function() {
    switch (site) {
      case 'www.amazon.cn':
      ...
      default:
        return logger.error("no available page parser for site %s", site);
    }
  })();
  return newParser;
};
