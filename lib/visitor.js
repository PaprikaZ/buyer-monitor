...
var AmazonCNVisitor, AmazonJPVisitor, AmazonUSVisitor, DBClient, JingDongVisitor, Messenger, Visitor, client, config, createParser, request,
...
Visitor = (function() {
  ...
  Visitor.prototype.parsePage = function(html) {
    ...
    parser = createParser(this.seed.site);
    result = {
      id: this.seed.id,
      site: this.seed.site,
      url: this.seed.url
