...
var PARSE_FIELD, PRODUCT_BASE_FIELD, accessTokens, assembleMessageBody, assembleMessageTitle, config, push, request, requestErrorHandler, responseErrorHandler, resultErrorHandler, tokenEmptyHandler, util;
...
assembleMessageTitle = function(result) {
  var title;
  if (PRODUCT_BASE_FIELD.reduce((function(partial, field) {
...
assembleMessageBody = function(result) {
  var body;
  if (PARSE_FIELD.reduce((function(partial, field) {
    return partial && result[field];
  }), true)) {
