...
var AVAILABLE_COMPARES, MANDATORY_BASE_FIELDS, MANDATORY_EXPAND_FIELDS, MANDATORY_VERDICT_FIELDS, Seed, config, generateProductUrl, htmlSuffix, httpPrefix, httpsPrefix, illegalTypeHandler, noneVerdictLoadedHandler, siteNotSupportHandler, siteTable, verdictMissingHandler, _MANDATORY_VERDICT_METHODS;
...
Seed = (function() {
  function Seed(product) {
    ...
    this.url = generateProductUrl(product.id, product.site);
    (function() {
      var verdictLoaded;
      verdictLoaded = false;
